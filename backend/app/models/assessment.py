import enum
from sqlalchemy import Integer, String, Enum, ForeignKey, JSON, DateTime
...
class AssessmentSession(Base):
    ...
    status: Mapped[AssessmentStatusEnum] = mapped_column(Enum(AssessmentStatusEnum), default=AssessmentStatusEnum.started)
...
class UserResponse(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    session_id: Mapped[int] = mapped_column(Integer, ForeignKey("assessment_sessions.id"))
